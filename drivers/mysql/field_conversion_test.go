...
func TestMySQLConvertFieldNames(t *testing.T) {
...
func TestMySQLConvertResultFieldNames(t *testing.T) {
...
func TestMySQLConvertFieldNamesWithUnregisteredSchema(t *testing.T) {
	// Create test database
	config := types.Config{
		Type: "mysql",
	}
...
func TestMySQLConvertResultFieldNamesWithUnregisteredSchema(t *testing.T) {
	// Create test database
	config := types.Config{
		Type: "mysql",
	}
